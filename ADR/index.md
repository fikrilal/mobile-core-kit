...
Baseline ADRs (apply to `mobile-core-kit` adopters):

- `records/0001-use-adrs-in-this-template.md` — Use ADRs in this template (accepted, 2025‑12‑12)
- `records/0002-clean-architecture-vertical-slices.md` — Clean Architecture with vertical slices (accepted, 2025‑12‑12)
- `records/0003-getit-di-per-feature-modules.md` — GetIt DI with per‑feature modules (accepted, 2025‑12‑12)
