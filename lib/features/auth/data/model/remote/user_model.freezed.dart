...
@override
String toString() {
  return 'UserModel(id: $id, email: $email, displayName: $displayName, emailVerified: $emailVerified, createdAt: $createdAt, avatarUrl: $avatarUrl, accessToken: $accessToken, refreshToken: $refreshToken, expiresIn: $expiresIn)';
}
...
class _UserModel extends UserModel {
  const _UserModel({this.id, this.email, this.displayName, this.emailVerified, this.createdAt, this.avatarUrl, this.accessToken, this.refreshToken, this.expiresIn}): super._();
