...
mixin _$AuthResponseModel {
 ...
 MeModel get user; String get accessToken; String get refreshToken;
...
@useResult
$Res call({
 MeModel user, String accessToken, String refreshToken
});


$MeModelCopyWith<$Res> get user;
...
as MeModel,accessToken: null == accessToken ? _self.accessToken : accessToken // ignore: cast_nullable_to_non_nullable
...
$MeModelCopyWith<$Res> get user {
  ...
  return $MeModelCopyWith<$Res>(_self.user, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( MeModel user,  String accessToken,  String refreshToken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthResponseModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( MeModel user,  String accessToken,  String refreshToken)  $default,) {final _that = this;
switch (_that) {
case _AuthResponseModel():
return $default(_that.user,_that.accessToken,_that.refreshToken);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( MeModel user,  String accessToken,  String refreshToken)?  $default,) {final _that = this;
switch (_that) {
case _AuthResponseModel() when $default != null:
return $default(_that.user,_that.accessToken,_that.refreshToken);case _:
  return null;
...
class _AuthResponseModel extends AuthResponseModel {
  const _AuthResponseModel({required this.user, required this.accessToken, required this.refreshToken}): super._();
  factory _AuthResponseModel.fromJson(Map<String, dynamic> json) => _$AuthResponseModelFromJson(json);

@override final  MeModel user;
...
@override $MeModelCopyWith<$Res> get user;
