...
@override
String toString() {
  return 'UserModel(id: $id, email: $email, firstName: $firstName, lastName: $lastName, emailVerified: $emailVerified, createdAt: $createdAt)';
}
...
class _UserModel extends UserModel {
  const _UserModel({required this.id, required this.email, this.firstName, this.lastName, this.emailVerified, this.createdAt}): super._();
