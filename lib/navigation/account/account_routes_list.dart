...
import 'package:mobile_core_kit/features/account/subfeatures/profile/presentation/pages/edit_profile_page.dart';
...
final List<GoRoute> accountRoutes = [
  ...
  GoRoute(
    path: AccountRoutes.editProfile,
    name: 'edit-profile',
    builder: (context, state) => BlocProvider<EditProfileCubit>(
      create: (_) => locator<EditProfileCubit>()..loadCurrentProfile(),
