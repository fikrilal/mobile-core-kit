...
Deep dives on “how this works” (not day-to-day patterns and not cross-team contracts).
...
- `docs/explainers/core/architecture/...` — architecture deep dives (e.g. Dependency Inversion, port/adapter patterns).
