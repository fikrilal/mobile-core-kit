...
class _FakeConnectivityService implements ConnectivityService {
  ...
  @override
  Stream<NetworkStatus> get networkStatusStream => Stream<NetworkStatus>.empty();
...
void main() {
  group('ApiHelper error handling', () {
    test('does not treat non-envelope {status: 401} payload as envelope', () async {
      final dio = Dio()
        ..interceptors.add(
          InterceptorsWrapper(
    ...
    test('preserves RFC7807 code/traceId when throwOnError=false and converts to Either', () async {
      ...
      final Either<ApiFailure, Map<String, dynamic>> either =
          resp.toEitherWithFallback('fallback');
