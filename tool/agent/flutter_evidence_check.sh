...
usage() {
  cat >&2 <<'EOF'
Usage:
  tool/agent/flutter_evidence_check.sh --device <device-id> [--flavor <dev|staging|prod>] [--target <integration_test/..._test.dart>] [--artifacts-dir <path>] [--no-example-env-fallback] [--google-services-json <path>]
...
Examples:
  tool/agent/flutter_evidence_check.sh --device emulator-5554
  tool/agent/flutter_evidence_check.sh --device emulator-5554 --target integration_test/auth_happy_path_test.dart
  tool/agent/flutter_evidence_check.sh --device emulator-5554 --flavor dev --artifacts-dir _artifacts/mobile/manual-run
  tool/agent/flutter_evidence_check.sh --device emulator-5554 --google-services-json /secure/path/google-services.json
EOF
}
